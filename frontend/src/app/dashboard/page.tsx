...
export default function DashboardHome() {
  const [activeTab, setActiveTab] = useState<'dashboard' | 'orders' | 'devices' | 'settings'>(
    'dashboard'
  );
  ...
  const devices: Device[] = [
    ...
    {
      name: 'Kitchen-Tab-02',
      station: 'Estación de Fríos y Ensaladas',
      status: 'ONLINE',
      uptime: '14h 28m',
      ping: 16,
    },
    ...
    {
      name: 'Kitchen-Tab-04',
      station: 'Estación de Despacho',
      status: 'ONLINE',
      uptime: '14h 34m',
      ping: 8,
    },
    {
      name: 'Kitchen-Display-Main',
      station: 'Pantalla Central KDS',
      status: 'ALERT',
      uptime: '02h 11m',
      ping: 145,
    },
    {
      name: 'Kitchen-Tab-Backup',
      station: 'Móvil Auxiliar (Entradas)',
      status: 'OFFLINE',
      uptime: '0h 0m',
      ping: 0,
    },
              ...
              <li className={activeTab === 'orders' ? 'sidebar-item-active' : ''}>
                ...
                >
                  ...
                  <span
                    ...
                    style={{ marginLeft: 'auto', padding: '1px 6px', fontSize: '0.65rem' }}
                  >
                ...
                >
                  ...
                  <span
                    ...
                    style={{
                      ...
                      padding: '1px 6px',
                      fontSize: '0.65rem',
                      background: 'hsl(var(--accent-success-hsl) / 0.1)',
                      color: 'hsl(var(--accent-success-hsl))',
                    }}
                  >
        ...
        <header className="top-bar">
          ...
          <div style={{ display: 'flex', gap: '1rem', alignItems: 'center' }}>
            <span
              ...
              style={{
                padding: '6px 12px',
                border: '1px solid hsl(var(--accent-success-hsl) / 0.3)',
              }}
            >
          ...
          >
            ...
            <div className="dashboard-grid">
              ...
              <div className="card stat-card card-cyan">
                <div className="stat-header">
                  ...
                  <div className="stat-icon" style={{ color: 'hsl(var(--accent-secondary-hsl))' }}>
                    <Icons.Timer />
                  </div>
                </div>
                <div className="stat-value">11.8m</div>
                <div
                  className="stat-change stat-change-up"
                  style={{ color: 'hsl(var(--accent-secondary-hsl))' }}
                >
                  <Icons.TrendUp />
              ...
              <div className="card stat-card">
                ...
                <div className="stat-change text-muted" style={{ display: 'flex', gap: '6px' }}>
                  <span
                    className="badge-dot"
                    style={{ backgroundColor: 'hsl(var(--accent-warning-hsl))' }}
                  />
              ...
              <div className="card stat-card">
                ...
                <div className="stat-change stat-change-down">
                  <span
                    style={{
                      color: 'hsl(var(--accent-warning-hsl))',
                      display: 'inline-flex',
                      alignItems: 'center',
                      gap: '4px',
                    }}
            ...
            <div className="content-row">
              ...
              >
                ...
                >
                  <div>
                    <h3 style={{ fontFamily: 'var(--font-outfit)', fontSize: '1.25rem' }}>
                      Cola de Tickets Prioritarios
                    </h3>
                    <p className="text-muted" style={{ fontSize: '0.85rem' }}>
                      Tickets ordenados según hora de ingreso y prioridad de despacho
                    </p>
                  </div>
                  <button
                    onClick={() => setActiveTab('orders')}
                            ...
                            <div style={{ display: 'flex', flexDirection: 'column', gap: '2px' }}>
                              {order.items.map((item, idx) => (
                                <span key={idx} style={{ fontSize: '0.85rem' }}>
                                  <strong style={{ color: 'hsl(var(--accent-primary-hsl))' }}>
                                    {item.qty}x
                                  </strong>{' '}
                                  {item.name}
                                </span>
              ...
              >
                <h3 style={{ fontFamily: 'var(--font-outfit)', fontSize: '1.15rem' }}>
                  Ajustes del KDS
                </h3>
                <p className="text-muted" style={{ fontSize: '0.85rem' }}>
                  Control visual del sistema operativo de cocina en tiempo real.
                </p>
                ...
                <div
                  style={{
                    background: 'hsl(var(--slate-950) / 0.5)',
                    border: '1px solid hsl(var(--slate-800) / 0.5)',
                ...
                >
                  ...
                  <p style={{ fontSize: '0.8rem', color: 'var(--text-secondary)' }}>
                    Desarrollado en <strong>Vanilla CSS</strong> con variables de HSL para
                    rendimiento extremo y animación libre de retraso (Zero Lag).
                  </p>
                </div>
              </div>
            </div>
        ...
        {activeTab === 'orders' && (
          ...
          >
            ...
            <div className="tabs-container">
              ...
              <button className="tab-btn" onClick={() => setActiveTab('dashboard')}>
                Pendientes ({orders.filter((o) => o.status === 'PENDIENTE').length})
              </button>
              <button className="tab-btn" onClick={() => setActiveTab('dashboard')}>
                En Cocción ({orders.filter((o) => o.status === 'PREPARANDO').length})
              </button>
              <button className="tab-btn" onClick={() => setActiveTab('dashboard')}>
                Listos para Despacho ({orders.filter((o) => o.status === 'LISTO').length})
              </button>
            </div>
            ...
            <div className="ticket-list">
              {orders.map((order) => (
                <div
                  key={order.id}
                  className={`card ticket-card ${order.urgency === 'Alto' && order.status === 'PREPARANDO' ? 'card-cyan' : ''}`}
                  style={{
                    borderLeft:
                      order.urgency === 'Alto'
                        ? '4px solid hsl(var(--accent-danger-hsl))'
                ...
                >
                  ...
                  <div className="ticket-footer">
                    <div>
                      <span
                        className="text-muted"
                        style={{ fontSize: '0.7rem', fontWeight: 700, display: 'block' }}
                      >
                        PRIORIDAD
                      </span>
                      <span
                        style={{
                          ...
                          color:
                            order.urgency === 'Alto'
                              ? 'hsl(var(--accent-danger-hsl))'
                              : order.urgency === 'Medio'
                                ? 'hsl(var(--accent-warning-hsl))'
                                : 'hsl(var(--accent-success-hsl))',
                        }}
                      >
                        {order.urgency}
                      </span>
                    ...
                    <button
                      ...
                      style={{
                        ...
                        background:
                          order.status === 'LISTO'
                            ? 'linear-gradient(135deg, hsl(var(--accent-success-hsl)), hsl(var(--accent-success-hsl) / 0.85))'
                            : undefined,
                        boxShadow:
                          order.status === 'LISTO'
                            ? '0 4px 12px hsl(var(--accent-success-hsl) / 0.2)'
                            : undefined,
                      }}
                    >
                      <Icons.Check />
          ...
          >
            <div className="card">
              ...
              >
                <div>
                  <h3 style={{ fontFamily: 'var(--font-outfit)', fontSize: '1.25rem' }}>
                    Dispositivos y Pantallas de Cocina
                  </h3>
                  <p className="text-muted" style={{ fontSize: '0.85rem' }}>
                    Estaciones KDS (Kitchen Display System) monitoreadas mediante WebSockets en
                    tiempo real.
                  </p>
                </div>
                <span
              ...
              <div className="table-container">
                <table className="custom-table">
                  ...
                  <tbody>
                    {devices.map((dev, idx) => (
                      <tr key={idx}>
                        <td style={{ fontWeight: 700, fontFamily: 'var(--font-outfit)' }}>
                          {dev.name}
                        </td>
                        <td>
                          <span style={{ fontWeight: 500 }}>{dev.station}</span>
                        </td>
                        <td>
                          {dev.status === 'ONLINE' && (
                            <span className="badge badge-success">
          ...
          >
            ...
            >
              <div>
                ...
                <p className="text-muted" style={{ fontSize: '0.85rem' }}>
                  Controlá las variables HSL de Vanilla CSS en caliente. Todos los ajustes se
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
                <div className="form-group">
                  ...
                  <select
                    ...
                    style={{ width: '100%', background: 'hsl(var(--slate-950))' }}
                  >
                    <option value="slate-premium">Slate Premium Oscuro (Por Defecto)</option>
                    <option value="carbon-midnight" disabled>
                      Carbon Midnight (Próximamente)
                    </option>
                    <option value="emerald-aurora" disabled>
                      Emerald Aurora (Próximamente)
                    </option>
                  </select>
                </div>
                ...
                <div className="form-toggle">
                  <div>
                    <span style={{ fontSize: '0.95rem', fontWeight: 600, display: 'block' }}>
                      Habilitar Efectos Neon & Glow
                    </span>
                    <span
                      className="text-muted"
                      style={{ fontSize: '0.8rem', display: 'block', marginTop: '2px' }}
                    >
                      Agrega una sutil sombra difuminada con el color de acento HSL a las tarjetas
                      al pasar el cursor.
                    </span>
                  </div>
                  <label className="switch">
                ...
                <div className="form-toggle">
                  <div>
                    <span style={{ fontSize: '0.95rem', fontWeight: 600, display: 'block' }}>
                      Fondo Traslúcido de Vidrio (Glassmorphism)
                    </span>
                    <span
                      className="text-muted"
                      style={{ fontSize: '0.8rem', display: 'block', marginTop: '2px' }}
                    >
                      Modifica la intensidad del blur de fondo en los componentes flotantes.
                    </span>
                  </div>
                  <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
                    <span
                      style={{
                        fontSize: '0.85rem',
                        fontWeight: 700,
                        color: 'hsl(var(--accent-secondary-hsl))',
                      }}
                    >
                      {glassIntensity}px
                    </span>
                ...
                <div style={{ display: 'flex', gap: '1rem', marginTop: '1rem' }}>
                  <button
                    className="btn btn-primary"
                    onClick={() => alert('Ajustes guardados correctamente en localStorage')}
                  >
                    Guardar Cambios
                  </button>
                  <button
            ...
            >
              <h3 style={{ fontFamily: 'var(--font-outfit)', fontSize: '1.15rem' }}>
                Consola de Diagnóstico HSL
              </h3>
              <p className="text-muted" style={{ fontSize: '0.85rem' }}>
                Lectura en tiempo real de los tokens de color inyectados en el DOM:
              </p>
              ...
              >
                <div>
                  <span style={{ color: 'hsl(var(--accent-secondary-hsl))' }}>--bg-app</span>:
                  hsl(222, 47%, 6%) <span style={{ color: 'var(--text-muted)' }}>#030712</span>
                </div>
                <div>
                  <span style={{ color: 'hsl(var(--accent-secondary-hsl))' }}>
                    --accent-primary-hsl
                  </span>
                  : 250, 85%, 64% <span style={{ color: 'var(--text-muted)' }}>#6366f1</span>
                </div>
                <div>
                  <span style={{ color: 'hsl(var(--accent-secondary-hsl))' }}>
                    --accent-secondary-hsl
                  </span>
                  : 195, 90%, 50% <span style={{ color: 'var(--text-muted)' }}>#06b6d4</span>
                </div>
                <div>
                  <span style={{ color: 'hsl(var(--accent-secondary-hsl))' }}>
                    --glass-intensity
                  ...
                  : {glassIntensity}px{' '}
                  <span style={{ color: 'var(--text-muted)' }}>backdrop-filter</span>
                </div>
                <div>
                  <span style={{ color: 'hsl(var(--accent-secondary-hsl))' }}>--glow-effect</span>:{' '}
                  {glowEnabled ? 'Active' : 'Inactive'}
                </div>
              </div>
            </div>
          </div>
