...
describe('quantity-normalization', () => {
  it('parses common quantity formats', () => {
    ...
    expect(parseQuantity('3 unidades')).toMatchObject({ value: 3, unit: 'unidad', structured: true });
    expect(parseQuantity('3 tomates')).toMatchObject({ value: 3, unit: 'unidad', structured: true });
    ...
    expect(parseQuantity('1 paquete')).toMatchObject({ value: 1, unit: 'paquete', structured: true });
